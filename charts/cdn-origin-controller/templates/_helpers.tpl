...
*/}}
{{- define "cdn-origin-controller.fullname" -}}
...
*/}}
{{- define "cdn-origin-controller.chart" -}}
...
Common labels
*/}}
{{- define "cdn-origin-controller.labels" -}}
app.kubernetes.io/name: {{ include "cdn-origin-controller.name" . }}
helm.sh/chart: {{ include "cdn-origin-controller.chart" . }}
